...
export default function LangSelector() {
  ...
  const current: LangOption = LANGS.find((l) => l.code === lang) ?? LANGS[0];
  ...
  const pick = (code: LangOption["code"]) => {
    setLang(code);
    setOpen(false);
  };
  ...
  return (
    <div style={{ position: "relative", display: "inline-block", lineHeight: 0 }}>
      ...
      >
        ...
        >
          <Flag code={current.flagCode} w={32} h={22} />
        </span>
      </button>
        ...
        createPortal(
          <div
            ...
            style={{
              ...
              overflowY: "auto",
              padding: 4,
              background: "var(--card-bg, var(--btn-bg))",
              border: "1px solid var(--border)",
              borderRadius: 10,
          ...
          >
            {LANGS.map((opt) => {
              ...
              return (
                ...
                >
                  <Flag code={opt.flagCode} w={22} h={15} />
