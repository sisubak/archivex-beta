  ...
  return (
    <div
      style={{
        position: "relative",
        padding:
          "clamp(0.75rem, 0.5rem + 0.6vw, 1.1rem) clamp(0.85rem, 0.6rem + 0.7vw, 1.3rem)",
        borderRadius: "12px",
    ...
    >
      ...
      <div
        style={{
          fontSize: "clamp(1.3rem, 1rem + 1.2vw, 2.2rem)",
          fontWeight: 700,
...
function ChatModal({ src, caption, onClose }: ChatModalProps) {
  ...
  return createPortal(
    ...
    >
      <style>{`
        @keyframes chatModalFadeIn { from { opacity: 0; } to { opacity: 1; } }
        @keyframes chatModalFadeOut { from { opacity: 1; } to { opacity: 0; } }
        @keyframes chatModalPopIn { from { opacity: 0; transform: scale(0.92); } to { opacity: 1; transform: scale(1); } }
        @keyframes chatModalPopOut { from { opacity: 1; transform: scale(1); } to { opacity: 0; transform: scale(0.9); } }
      `}</style>
      <div
        ref={dialogRef}
